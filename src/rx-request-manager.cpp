...
// rxcpp::observable<HttpResponse> RxRequestManager::send_request2(const std::string& url, HttpRequestMethod method, std::map<std::string, std::string> headers,
//                                const std::string& body)
// {
// 	return m_rx_curl->create(HttpRequest{url, method, std::move(headers), body});
// }
